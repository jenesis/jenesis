...
public class PalantirJavaFormatModuleRunTest {
    ...
    private BuildExecutor newExecutor() throws IOException {
        ...
        executor.addModule(
                ...
                new PalantirJavaFormatModule(Map.of("maven", MavenDefaultRepository.ofKeys(SYSTEM, new Output())), Map.of("maven", MavenPomResolver.ofKeys(SYSTEM))).pinning(Pinning.STRICT),
                "project");
        return executor;
    }
}
