...
The Scala counterpart to `../demo-31-java-quality`, following the Scala demo that
...
`../demo-31-java-quality` and `../demo-39-kotlin-quality`.

Pinning
-------

The Scala compiler is pinned in its own `scalac` group (see `../demo-41-scala`).
