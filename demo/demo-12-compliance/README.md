...
This is the supply-chain counterpart to the [`sbom`](../demo-11-sbom/README.md)
...
`licensing.properties` is absent. The module's other step, `VulnerabilityCheck`, applies
the other compliance gate over the same graph.

Layout
------

    demo/demo-12-compliance
