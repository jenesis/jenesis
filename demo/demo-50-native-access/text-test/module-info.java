/**
 * The tests of demo.natives.text. A test run is a run of its own, so it grants
 * the library native access itself rather than inheriting a grant from anywhere.
 *
 * @jenesis.release 25
 * @jenesis.test demo.natives.text
 ...
 */
open module demo.natives.text.test {
