...
The Kotlin counterpart to `../demo-10-java-quality`, following the Kotlin demo
...
`../demo-10-java-quality`. The formatters for the other JVM languages work the
same way.
...
the `kotlin.stdlib` the module ships against (see `../demo-15-kotlin`). detekt and
