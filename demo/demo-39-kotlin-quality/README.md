...
The Kotlin counterpart to `../demo-31-java-quality`, following the Kotlin demo
...
`../demo-31-java-quality`. The formatters for the other JVM languages work the
same way.
...
the `kotlin.stdlib` the module ships against (see `../demo-38-kotlin`). detekt and
