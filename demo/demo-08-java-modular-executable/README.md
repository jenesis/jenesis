...
and its POM-based sibling is `../demo-07-java-pom-executable`.
...
`<mainClass>` property, shown in `../demo-07-java-pom-executable`.

Layout
------

    demo/demo-08-java-modular-executable
...
classpath project (`../demo-07-java-pom-executable`) has nothing to pack or link.
...
instead of a module (see `../demo-07-java-pom-executable`); the launch command is the
...
This package is much smaller than the classpath sibling `../demo-07-java-pom-executable`
...
sibling `../demo-07-java-pom-executable`, which has to bundle a full runtime - less
