...
The Scala counterpart to `../demo-28-java-quality`, following the Scala demo that
...
`../demo-28-java-quality` and `../demo-35-kotlin-quality`.

Pinning
-------

The Scala compiler is pinned in its own `scalac` group (see `../demo-37-scala`).
