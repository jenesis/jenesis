...
`../demo-08-java-modular-executable`: where jpackage bundles a `jlink`-trimmed Java
...
The trade against the self-contained app-image (`../demo-08-java-modular-executable`)
...
`../demo-08-java-modular-executable`) is a third point: the same split closure plus a
