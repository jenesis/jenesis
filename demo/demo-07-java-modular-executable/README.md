...
and its POM-based sibling is `../demo-06-java-pom-executable`.
...
------
    ...
    demo/demo-07-java-modular-executable
...
This package is much smaller than the classpath sibling `../demo-06-java-pom-executable`
...
sibling `../demo-06-java-pom-executable`, which has to bundle a full runtime - less
