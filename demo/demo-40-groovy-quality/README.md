...
The Groovy counterpart to `../demo-28-java-quality`, following the Groovy demo
...
contribute a class to a package it does not also define (see `../demo-39-groovy`).

Pinning
-------

The Groovy compiler is pinned in its own `groovyc` group (see `../demo-39-groovy`).
