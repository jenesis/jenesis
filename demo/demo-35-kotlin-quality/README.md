...
The Kotlin counterpart to `../demo-28-java-quality`, following the Kotlin demo
...
`../demo-28-java-quality`. The formatters for the other JVM languages work the
same way.
...
the `kotlin.stdlib` the module ships against (see `../demo-34-kotlin`). detekt and
