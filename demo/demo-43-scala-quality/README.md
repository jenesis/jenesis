...
The Scala counterpart to `../demo-32-java-quality`, following the Scala demo that
...
`../demo-32-java-quality` and `../demo-40-kotlin-quality`.

Pinning
-------

The Scala compiler is pinned in its own `scalac` group (see `../demo-42-scala`).
