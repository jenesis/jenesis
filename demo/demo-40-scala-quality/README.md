...
The Scala counterpart to `../demo-30-java-quality`, following the Scala demo that
...
`../demo-30-java-quality` and `../demo-37-kotlin-quality`.

Pinning
-------

The Scala compiler is pinned in its own `scalac` group (see `../demo-39-scala`).
