...
it in a `jenesis.properties` at the project root - the same file `../demo-31-java-quality`
...
build can call `new Project<>(Path.of("."), new InferredMultiProjectAssembler()).layout(Project.Layout.MODULAR)` directly.

Layout
------

    demo-19-module-layout
