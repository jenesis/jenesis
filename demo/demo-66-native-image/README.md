...
itself. It is the ahead-of-time counterpart of `../demo-08-java-modular-executable`:
...
same way `../demo-34-code-coverage` runs JaCoCo. The `demo.graal.image.test`
...
Both `../demo-08-java-modular-executable` (jpackage) and this demo turn a modular
