...
The Groovy counterpart to `../demo-13-java-quality`, following the Groovy demo
...
contribute a class to a package it does not also define (see `../demo-23-groovy`).
