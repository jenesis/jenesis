...
The Scala counterpart to `../demo-10-java-quality`, following the Scala demo that
...
`../demo-10-java-quality` and `../demo-16-kotlin-quality`.

Pinning
-------

The Scala compiler is pinned in its own `scalac` group (see `../demo-18-scala`).
