...
`../demo-31-external-module` runs the identical plugin, but resolves it as a
...
*layout* in `../demo-24-module-layout` is the stricter case: it resolves only by
