...
The Kotlin counterpart to `../demo-11-java-quality`, following the Kotlin demo
...
`../demo-11-java-quality`. The formatters for the other JVM languages work the
same way.
...
the `kotlin.stdlib` the module ships against (see `../demo-16-kotlin`). detekt and
