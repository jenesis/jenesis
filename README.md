...
disables it. See the [`profiles`](demo/demo-13-profiles/README.md) demo and *Configuration*.
...
Maven repository as `<artifact>-<version>-cyclonedx.<ext>` for publication - see the [`sbom`](demo/demo-10-sbom/README.md) demo.
