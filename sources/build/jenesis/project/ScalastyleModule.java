...
public class ScalastyleModule implements BuildExecutorModule {
    ...
    public static ScalastyleModule ofEnvironment(Environment environment,
                                                 Map<String, Repository> repositories,
                                                 Map<String, Resolver> resolvers) {
        return new ScalastyleModule(Dependencies.ofEnvironment(environment, repositories, resolvers),
                null,
                "scalastyle",
                "scalastyle-config.xml",
                false,
                ProcessBuildStep.Terms.ofEnvironment(environment, "scalastyle"));
    }
