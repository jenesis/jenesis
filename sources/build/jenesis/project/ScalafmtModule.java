...
public class ScalafmtModule implements BuildExecutorModule {
    ...
    public static ScalafmtModule ofKeys(Function<String, String> keys,
                                        Output output,
                                        Map<String, Repository> repositories,
                                        Map<String, Resolver> resolvers) {
        return new ScalafmtModule(Dependencies.ofKeys(keys, output, repositories, resolvers),
                null,
                "scalafmt",
                ".scalafmt.conf",
                false,
                ProcessBuildStep.Terms.ofKeys(keys, output, "scalafmt"));
    }
